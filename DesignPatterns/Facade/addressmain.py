...
@Since : Dec'2019
@Keywords:Exception handling,abstraction,encapsulation,abstraction,Facade pattern.
@Description:This code is for facade design pattern. This is graphical user interface for addressbook. In this we created
 main function for address book and imported functions from addressbook class.
"""
...
class Address_Main(Addressbook):
    """
    Summary:This is main class, inheritance is used so that we can reuse the code and also functions like adding data, deleting
    data, updating data which are from other class are called here.
    """

    def __init__(self, file):
        """
        Summary:This funcion is called constructor, which is used for constructing object.
        """
    ...
    def main(self):
        """
        Summary:This function provides options for user, so that user can choose options according to his requirement.
        """
...
if __name__ == '__main__':
    """
    Summary:Interpretor starts execution here.
    """


    address = Address_Main("addres.json")
    address.main()